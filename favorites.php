<?php
	...
	$sql="INSERT INTO `favorite_books`(`favorite_book_id`) VALUES ('$id')";
	...
	$sql="SELECT * FROM `books` INNER JOIN `favorite_books` ON favorite_books.favorite_book_id=books.book_id";
	$result=mysqli_query($mysql,$sql);
...
<body>
				...
				<?php 
					...
					<div class=\"book-right\">
						<div class=\"book-links\">
							...
							<a href=\"favorites_delete.php?book_id=".$array[$i]['book_id']."\" id=\"more-link-add\">Delete from favorites</a>
	...
	<?php else:?>
		<div class="form-exit">
			<div class="tab-exit">
				<p>If you want to go favorites,you should log in.<a id="exit" href="login.php">Log in</a>.</p>
			</div>
		</div>
	<?php endif;?>
