...
<body>
		...
		<div class="content">
			...
			<div class="content-form">
				...
				<form action="upload.php" method="post" enctype="multipart/form-data">
					<input type="text" name="book_name" placeholder="book name"  style="" required="">
					<input type="text" name="book_author" placeholder="book author" required="">
					<input type="text" name="num_pages" placeholder="amount of pages" required="">
					<input type="text" name="date" placeholder="release date" required="">
					<input type="text" name="status" placeholder="status" required="">
					<input type="text" name="age_restric" placeholder="age restriction" required="">
					<input type="text" name="format" placeholder="format" required="">
					<input type="text" name="weight" placeholder="weight" required="">
					<input type="text" name="cover" placeholder="cover of book" required="">
	...
	<script type="text/javascript">
		...
		text.addEventListener("keyup",function(){
			...
			if(characters.length>442){
				lenText.style.color="red";
			}
